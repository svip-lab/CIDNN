...
def main():
    ...
    # model.main('fine-tune-TSD-GC', log=True, pre_train=True, pre_train_model_path='model/Cross-domain-OC-TSD/lr2e-3_cross_domain/lr_0.002_iter_40900')
    model.main('direct-GC', log=True, pre_train=False, pre_train_model_path='model/Cross-domain-OC-TSD/lr2e-3_cross_domain/lr_0.002_iter_40900')
