...
def main():
    ...
    model.main(model_path='model/Cross-domain-OC-TSD/lr2e-3_cross_domain/lr_0.002_iter_40900', use_gpu=True)
    model.evaluate(algorithm_version='None', batch_size=-1, draw_predict_image=False)
